    ...
    let Validation = {
        name: {
            Validate: [{
                ...
                message: " Please Specify Teacher's Full Name . ",
            }, {
            ...
            Validate: [
                {
                    ...
                    message: " Please Specify Teacher's User Name . ",
                }
            ],
            elem: "userName"
        },
        schoolName: {
            Validate: [{
                ...
                message: " Please Specify School Name . ",
            }
            ],
            elem: "schoolName"
        },
        emergencyNumber: {
            Validate: [
                {
                    condition: !/\d/.test(emergencyNumber) || /^(?!\d+$)(?:[a-zA-Z0-9][a-zA-Z0-9 @&$]*)?$/.test(emergencyNumber),
                    message: " Should Have Numbers Only . ",
                }, {
                    condition: /[ !@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(emergencyNumber),
                    message: " No Space Hyphens '-' Or Any Special Character . ",
                }

            ],
            elem: "emergencyNumber"
        },
        phoneNumber: {
            Validate: [
                {
            ...
            Validate: [
                {
                    ...
                    message: " Please specify Teacher's complete address. ",
                }
            ],
            elem: "address"
        },
